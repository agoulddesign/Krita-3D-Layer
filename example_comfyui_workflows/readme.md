...
- Ensure your workflow ends with a node that saves or previews a 3D mesh (e.g., `SaveMesh`, `Save 3D Mesh`, `PygltflibSave`, etc.).
- As long as the node output contains a path ending in `.glb`, the plugin will find it and download it automatically.
